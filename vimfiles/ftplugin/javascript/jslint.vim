...
if has("win32")
  ...
  let s:install_dir = '"' . expand("D:/lemon/software/vim/vimfiles/ftplugin/javascript") . '"'
else
...
if !exists("*s:RenderErrorFn")
  function s:RenderErrorFn()
    call s:JSLint()
  endfun
  command RenderError :call s:RenderErrorFn()
endif

"F4来激发/撤销语法检查
noremap <F4> :RenderError<CR>
